...
const AvailableHomesiteCard = ({ obj }) => {
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-2 bg-dark-blue text-center">
                <p className="text-xs text-gray-200 text-center uppercase tracking-wide">Under Construction</p>
                <h5 className="font-semibold tracking-tight text-white">{obj?.address}</h5>
                <p className="text-xs text-gray-200 text-center uppercase tracking-wide">
                    {obj?.community}</p>
...
export default AvailableHomesiteCard;
